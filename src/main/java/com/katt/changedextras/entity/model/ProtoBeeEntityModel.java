...
import java.util.List;public class ProtoBeeEntityModel extends AdvancedHumanoidModel<ProtoBeeEntity> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION =
            new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(ChangedExtras.MODID, "proto_bee"), "main");
    ...
    private final HumanoidAnimator<ProtoBeeEntity, ProtoBeeEntityModel> animator;
    ...
    public ProtoBeeEntityModel(ModelPart root) {
        super(root);
        ...
        this.animator = HumanoidAnimator.of(this).hipOffset(-1.5f)
                .addPreset(AnimatorPresets.wolfLike(
                        this.Head, this.LeftEar, this.RightEar2,
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition Head = partdefinition.addOrReplaceChild("Head", CubeListBuilder.create().texOffs(25, 2).addBox(-3.0F, -5.9099F, -0.371F, 6.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.1067F, -0.7855F, -0.7724F, 0.0436F, 0.0F, 0.0F));

        PartDefinition head_r1 = Head.addOrReplaceChild("head_r1", CubeListBuilder.create().texOffs(0, 89).mirror().addBox(3.0F, 0.0F, -2.5F, 0.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.7866F, -2.9099F, 4.129F, 0.0F, 0.9163F, 0.0F));

        PartDefinition head_r2 = Head.addOrReplaceChild("head_r2", CubeListBuilder.create().texOffs(0, 89).addBox(-3.0F, 0.0F, -2.5F, 0.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-3.0F, -2.9099F, 4.129F, 0.0F, -0.9163F, 0.0F));
        ...
        PartDefinition cube_r1 = LeftEar.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(72, 30).addBox(0.0003F, -0.3869F, 3.4012F, 2.0F, 3.0F, 4.0F, new CubeDeformation(-0.1F)), PartPose.offsetAndRotation(-3.0845F, 3.6265F, 0.2005F, 0.1745F, -0.384F, 0.0F));

        PartDefinition cube_r2 = LeftEar.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(0, 84).addBox(-0.2097F, -0.1769F, -0.7984F, 2.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.9595F, 3.3765F, 0.5255F, 0.1745F, -0.384F, 0.0F));

        PartDefinition RightEar2 = Head.addOrReplaceChild("RightEar2", CubeListBuilder.create(), PartPose.offsetAndRotation(0.423F, -8.0145F, -2.5F, 0.3491F, 0.0F, 0.0F));

        PartDefinition cube_r3 = RightEar2.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(72, 30).mirror().addBox(-2.0003F, -0.3869F, 3.4012F, 2.0F, 3.0F, 4.0F, new CubeDeformation(-0.1F)).mirror(false), PartPose.offsetAndRotation(3.0845F, 3.6265F, 0.2005F, 0.1745F, 0.384F, 0.0F));

        PartDefinition cube_r4 = RightEar2.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(0, 84).mirror().addBox(-1.7903F, -0.1769F, -0.7984F, 2.0F, 3.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(2.9595F, 3.3765F, 0.5255F, 0.1745F, 0.384F, 0.0F));
        ...
        PartDefinition Base_r1 = TailPrimary.addOrReplaceChild("Base_r1", CubeListBuilder.create().texOffs(13, 83).addBox(-3.0F, -0.25F, -1.5F, 6.0F, 6.0F, 7.0F, new CubeDeformation(-0.2F)), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, 1.0908F, 0.0F, 0.0F));

        PartDefinition TailSecondary = TailPrimary.addOrReplaceChild("TailSecondary", CubeListBuilder.create(), PartPose.offset(0.0F, 1.25F, 4.5F));

        PartDefinition Base_r2 = TailSecondary.addOrReplaceChild("Base_r2", CubeListBuilder.create().texOffs(58, 80).addBox(-4.5F, -0.45F, -3.5F, 9.0F, 6.0F, 10.0F, new CubeDeformation(-0.3F)), PartPose.offsetAndRotation(0.0F, 0.5F, 0.0F, 1.3526F, 0.0F, 0.0F));
        ...
        PartDefinition Base_r3 = TailTertiary.addOrReplaceChild("Base_r3", CubeListBuilder.create().texOffs(0, 62).addBox(-3.5F, 3.55F, -3.3F, 7.0F, 9.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, -0.25F, -4.5F, 1.5272F, 0.0F, 0.0F));
        ...
        PartDefinition Base_r4 = TailQuaternary.addOrReplaceChild("Base_r4", CubeListBuilder.create().texOffs(68, 74).addBox(-1.0F, 5.5F, -0.8F, 2.0F, 3.0F, 1.0F, new CubeDeformation(0.15F)), PartPose.offsetAndRotation(0.0F, -1.0F, -5.5F, 1.7017F, 0.0F, 0.0F));

        PartDefinition RightArm = partdefinition.addOrReplaceChild("RightArm", CubeListBuilder.create().texOffs(28, 25).addBox(-3.0F, -2.0F, -2.0F, 4.0F, 12.0F, 4.0F, new CubeDeformation(0.0F)), PartPose.offset(-5.0F, 2.0F, 0.0F));
        ...
        PartDefinition LeftThigh_r1 = LeftLeg.addOrReplaceChild("LeftThigh_r1", CubeListBuilder.create().texOffs(40, 52).mirror().addBox(-2.0F, 0.0F, -2.0F, 4.0F, 7.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, 0.0F, 0.0F, -0.2182F, 0.0F, 0.0F));

        PartDefinition LeftLowerLeg = LeftLeg.addOrReplaceChild("LeftLowerLeg", CubeListBuilder.create(), PartPose.offset(0.0F, 6.375F, -3.45F));

        PartDefinition LeftCalf_r1 = LeftLowerLeg.addOrReplaceChild("LeftCalf_r1", CubeListBuilder.create().texOffs(56, 54).mirror().addBox(-2.01F, -0.125F, -2.9F, 4.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offsetAndRotation(0.0F, -2.125F, 1.95F, 0.8727F, 0.0F, 0.0F));

        PartDefinition LeftFoot = LeftLowerLeg.addOrReplaceChild("LeftFoot", CubeListBuilder.create(), PartPose.offset(0.0F, 0.8F, 7.175F));

        PartDefinition LeftArch_r1 = LeftFoot.addOrReplaceChild("LeftArch_r1", CubeListBuilder.create().texOffs(70, 12).mirror().addBox(-2.0F, -8.45F, -0.725F, 4.0F, 6.0F, 3.0F, new CubeDeformation(0.005F)).mirror(false), PartPose.offsetAndRotation(0.0F, 7.075F, -4.975F, -0.3491F, 0.0F, 0.0F));

        PartDefinition LeftPad = LeftFoot.addOrReplaceChild("LeftPad", CubeListBuilder.create().texOffs(32, 63).mirror().addBox(-2.0F, 0.0F, -2.5F, 4.0F, 2.0F, 5.0F, new CubeDeformation(0.0F)).mirror(false), PartPose.offset(0.0F, 4.325F, -4.425F));

        return LayerDefinition.create(meshdefinition, 96, 96);
    }

    @Override
    public void setupHand(ProtoBeeEntity entity) {
        animator.setupHand();
    }
    @Override
    public void setupAnim(@NotNull ProtoBeeEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
    ...
    @Override
    public HumanoidAnimator<ProtoBeeEntity, ?> getAnimator(ProtoBeeEntity entity) {
        return animator;
    }
